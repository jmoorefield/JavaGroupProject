...
/* This class contains functionality for a letter tile. */
...
public class Tile
{
    // data to hold image of tile, its letter, points value,
    // position on the board, and whether it has been used
    // in a previous move on the board
    ...
    // GUI component to handle a player moving tiles
    ...
    // accessor functions for tile data
    ...
    // setter functions for tile data
    ...
    private void setHandlers()
    {
        ...
        dragging = event ->
        {
            ...
            if(child.isVisible())
            {
                // the clipboard can only hold string values, which is why the points value
                // is converted before adding
        ...
        droppedTile = event ->
        {
            ...
            if(event.getTarget().getClass() == StackPane.class)
            {
                ...
                // split the clipboard string of letter + points value
                ...
                // when the tile is dropped on the board, send its information to the Board class
