...
public class Tile
{
    ...
    //*******************************************************************************
    // * Name: Tile                                                                 *
    // * Description:  initializes the colored tiles as "empty", but capable of doubling
    // * or tripling the values on the board                                       *
    // * Last Modified by: Abigail Taylor                                           *
    // * Date:  07/26/2021    (2:15pm)                                              *
    // ******************************************************************************


    public LtBlueTile(String letter)
    {
        this.holder.setStyle("-fx-background-color: #bbdff7");  //light blue        
        //doubles the score of the tile placed here
        this.value = 
    }

    public DrkBlueTile(String letter)
    {
        this.holder.setStyle("-fx-background-color: #2f9de6");  //dark blue
        //triples the score the tile placed here
    }

    public PinkTile(String letter)
    {
        this.holder.setStyle("-fx-background-color: #ffa1a1");   //color pink (or salmon)        
        //doubles the score of the entire word
    }

    public RedTile(String letter)
    {
        this.holder.setStyle("-fx-background-color: #ff1a1a");  //color red
        //triples the score of the entire word
    } 
