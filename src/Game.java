...
public class Game extends Application
{
    ...
    public void start(Stage stage)
    {
        ...
        player1.getPlayerRack().setViewRackMove(false);
        ...
        //player select logic should go here
        select.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event)
            {
                if(!select.isDisable())
                {
                    ...
                    textPrompt.getPrompt().appendText("It's player 1 Turn \n");
                    event.consume();
                }
                event.consume();
            }
       ...
       move.setOnMouseClicked(new EventHandler<MouseEvent>() {
           @Override
           public void handle(MouseEvent event) {
               player1.getPlayerRack().setViewRackMove(true);
