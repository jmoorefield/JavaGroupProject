...
public class Board
{
    ...
    // logic for when the end of turn button is clicked
    // will return all the tiles in the player's current move
   /* public Vector<Tile> clickEndOfTurn() {
        Vector<Tile> playerMove;
        // for every tile just placed down
            //playerMove.add(tile);
        return playerMove;
    }
    */
